...
WORKDIR /root
RUN wget https://www.foundationdb.org/downloads/6.3.18/ubuntu/installers/foundationdb-clients_6.3.18-1_amd64.deb && dpkg -i foundationdb-clients_6.3.18-1_amd64.deb
COPY . /app
WORKDIR /app
...
COPY --from=1 /root/foundationdb-clients_6.3.18-1_amd64.deb /root/
RUN dpkg -i /root/foundationdb-clients_6.3.18-1_amd64.deb
